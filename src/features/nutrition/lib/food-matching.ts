/**
 * Emparejamiento de nombres de alimentos contra el catalogo.
 *
 * Lo usa el importador de dietas con IA para reconocer que "Claras de
 * huevo" del plan es la "Clara de huevo" que ya existe, en vez de crear un
 * alimento personalizado duplicado.
 *
 * El emparejamiento anterior tomaba la primera palabra y hacia ilike:
 * fallaba con plurales ("Claras" no encontraba "Clara") y con acentos
 * ("atún" no encontraba "Atun"), y ademas se quedaba con el primer
 * resultado arbitrario. Cada fallo dejaba un duplicado permanente en la
 * biblioteca.
 */
