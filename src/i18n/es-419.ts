...
export const messages = {
  ...
  recipes: {
    ...
    steps: {
      title: "Pasos",
      description: "Marca cada paso mientras cocinas.",
      empty: "Aun no hay pasos. Agregalos para seguir la receta uno a uno.",
      add: "Agregar paso",
      placeholder: "Ej. Picar la cebolla en cubos pequenos",
      moveUp: "Subir paso",
      moveDown: "Bajar paso",
      remove: "Quitar paso",
      added: "Paso agregado.",
      updated: "Paso actualizado.",
      removed: "Paso eliminado.",
      done: "Hecho",
      progress: "{done} de {total} pasos",
      failed: "No pudimos completar la accion. Intenta de nuevo.",
      legacyNotice:
        "Estas instrucciones venian de un solo bloque de texto. Se conservan por si la division en pasos quedo mal.",
    },
    notes: {
      storageTitle: "Conservacion",
      storagePlaceholder: "Ej. hasta 3 dias en refrigeracion, en envase hermetico",
      mealPrepTitle: "Meal prep",
      mealPrepPlaceholder: "Ej. rinde 4 porciones; congelar las que no se usen",
      save: "Guardar notas",
    ...
    variant: {
      ...
      badge: "Variante",
      ofRecipe: "Variante de otra receta",
    },
  },
  progress: {
    title: "Progreso",
